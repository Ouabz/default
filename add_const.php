...
<head>
    ...
    <title>Ajouter un constructeur</title>
    <!-- CSS -->
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row">
                <ul class="nav responsive-tab nav-material nav-material-white">
                    <li>
                        <a class="nav-link" href="list_const.php"><i class="icon icon-list"></i>Tout les constructeur</a>
                    </li>
                    <li>
                        <a class="nav-link active" href="#"><i
                                class="icon icon-plus-circle"></i> Ajoutez un constructeur</a>
                    </li>
                ...
                <div class="col-md-8 ">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <form method="post" action="core/services/constructeur-services.php?action=addMarque" enctype="multipart/form-data">
                                <label for="validationCustom04">Nom du constructeur</label>
                                <input type="text" name="name"class="form-control" id="validationCustom04" value="Toyota"
                                       >
                        </div>
