        ...
        <ul class="sidebar-menu">
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="index-2.html"><i class="icon icon-folder5"></i>Changez son mot de passe</a>
                    </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>
                        <a href="#"><i class="icon icon-documents3"></i>Blank Pages<i
